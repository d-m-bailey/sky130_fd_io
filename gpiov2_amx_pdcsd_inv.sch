...
N -40 -30 -40 -0 { lab=A}
N 150 30 150 60 { lab=VSSA}
N 110 60 150 60 { lab=VSSA}
N 110 30 110 60 { lab=VSSA}
...
C {devices/opin.sym} 200 0 0 0 {name=p2 lab=Y}
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 130 30 0 0 {name=I3
L=0.5
W=1.5
nf=1
mult=1
...
C {common/gnd.sym} 150 60 0 0 {name=l3 lab=VSSA}
