...
S {}
E {}
N 180 -100 180 -70 { lab=fbk}
N 230 -120 230 -70 { lab=fbk_n}
N 270 -110 270 -100 { lab=fbk}
N 140 -110 140 -100 { lab=fbk_n}
N 140 -120 230 -120 { lab=fbk_n}
N 180 -100 270 -100 { lab=fbk}
N 380 -110 580 -110 { lab=fbk}
...
N 180 -150 180 -100 { lab=fbk}
N 270 -120 270 -110 { lab=fbk}
...
N 580 -110 580 90 { lab=fbk}
N 580 -150 580 -110 { lab=fbk}
...
N 210 180 210 210 { lab=VPWR_KA}
N 210 270 210 300 { lab=VGND}
N -110 270 -110 300 { lab=VGND}
N -110 180 -110 210 { lab=VPWR_KA}
...
C {common/vdd.sym} 210 180 0 0 {name=l14 lab=VPWR_KA}
C {common/vdd.sym} -110 180 0 0 {name=l15 lab=VPWR_KA}
...
C {common/vdd.sym} 60 60 0 0 {name=l20 lab=VPWR_KA}
C {common/vdd.sym} 340 60 0 1 {name=l21 lab=VPWR_KA}
C {devices/opin.sym} -210 -110 0 1 {name=p5 lab=OUT_H_N}
C {devices/opin.sym} 620 -110 0 0 {name=p6 lab=OUT_H}
C {devices/lab_wire.sym} 20 -110 0 0 {name=l23 sig_type=std_logic lab=fbk_n}
C {devices/lab_wire.sym} 380 -110 0 0 {name=l24 sig_type=std_logic lab=fbk}
C {common/gnd.sym} 210 300 0 0 {name=l25 lab=VGND}
C {devices/iopin.sym} -10 -270 0 0 {name=p7 lab=VCC_IO}
C {devices/iopin.sym} -10 -250 0 0 {name=p8 lab=VPWR_KA}
